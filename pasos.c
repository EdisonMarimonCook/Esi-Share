...
int selector_camino(){  //Selector si el camino es de ida o de vuelra al momento de selecionar un viaje
    ...
    id=mostrarviaje(aux);  //iguala la funcion de mostrar viaje a la id para devolverla posteriormente
...
int mostrarviaje (int ciudad){  //Enseña los posibles viajes
    ...
    switch (ciudad){
        case 1:  //este caso se refiere a los viajes de Cadiz de ida a la ESI
            rewind(pasos);
            do{
                for(i=0;aux!='-';i++){
                    aux=fgetc(pasos);
                ...
                if(aux=='I'){
                    fgetc(pasos);
                    fgets(vector,5,pasos);
                    if(strcmp(vector,"Cadiz")==0){
        ...
        case 2:  //este caso se refiere a los viajes de Puerto Real de ida a la ESI
            ...
            do{
                ...
                if(aux=='I'){
                    fgetc(pasos);
                    fgets(vector,11,pasos);
                    if(strcmp(vector,"Puerto Real")==0){
                        fgets(vector,50,pasos);
                        printf("%d-%s", id, vector);  //Se imprimen los viajes disponibles por panatalla
                    }
                }
        ...
        case 4: //este caso se refiere a los viajes de Chiclana a la ESI
            ...
            do{
                ...
                if(aux=='I'){
                    fgetc(pasos);
                    fgets(vector,8,pasos);
                    if(strcmp(vector,"Chiclana")==0){
                        fgets(vector,50,pasos);
                        printf("%d-%s", id, vector);  //Se imprimen los viajes disponibles por panatalla
                    }
                }
        ...
        case 10:   //Este caso se refiere a los viajes de la ESI a Cadiz
            rewind(pasos);
            do{
                for(i=0;aux!='-';i++){
                    aux=fgetc(pasos);
    ...
    int id_aux;
    printf("Introduzca el ID del viaje que le interese: ");   //Se lee la id del viaje que el usuario quiera, y se seleciona dicha clase.
    scanf("%d", &id_aux);
